...
const LoginUi = (props) => {
  const { onSubmitHandler, onFinishModal, showModal, handleCancel, isModalVisible, modalNumber, onFinishOtp, onFinishPassword, form } = props;
